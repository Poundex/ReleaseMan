...
grails.project.fork = [
    ...
    // configure settings for th
    // e test-app JVM, uses the daemon by default
...
final String SPRING_INTEGRATION_VERSION="2.2.6.RELEASE"
...
grails.project.dependency.resolution = {
    ...
    dependencies {
	    ...
	    compile("org.codehaus.jackson:jackson-mapper-asl:1.9.11") // for jc
	    compile("com.google.guava:guava:13.0.1")
	    compile("org.apache.httpcomponents:httpclient:4.2.2")
	    compile("org.apache.httpcomponents:httpmime:4.2.2")
//	    compile("com.offbytwo.jenkins:jenkins-client:0.2.1-SNAPSHOT")
